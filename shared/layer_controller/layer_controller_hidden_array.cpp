...
class layer_control_trigger : cloneable_trigger_base {
    ...
    [text|tooltip:"The layer currently being edited.\nChanging this will update the vars UI"]
    int layer_index = 0;
    
    [text] layer_properties layer;
    [hidden] array<layer_properties> layers;
